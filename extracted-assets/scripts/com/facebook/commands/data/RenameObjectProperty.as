package com.facebook.commands.data
{
   ...
   public class RenameObjectProperty extends FacebookCall
   {
      ...
      public function RenameObjectProperty(param1:String, param2:String, param3:String)
      {
         super(METHOD_NAME);
         ...
         this.new_name = param3;
      }
      
      override facebook_internal function initialize() : void
      {
         applySchema(SCHEMA,this.obj_type,this.prop_name,this.new_name);
