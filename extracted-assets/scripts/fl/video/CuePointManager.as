package fl.video
{
   ...
   public class CuePointManager
   {
      ...
      flvplayback_internal function getCuePoint(param1:Array, param2:Boolean, param3:*) : Object
      {
         ...
         if((_loc5_ = flvplayback_internal::getCuePointIndex(param1,param2,_loc4_.time,_loc4_.name)) < 0)
         {
            return null;
         }
         (_loc4_ = flvplayback_internal::deepCopyObject(param1[_loc5_])).array = param1;
         _loc4_.index = _loc5_;
         return _loc4_;
      }
      ...
      public function processFLVCuePoints(param1:Array) : void
      {
         ...
         _loc7_ = 0;
         while((_loc4_ = flvplayback_internal::flvCuePoints[_loc7_++]) != undefined)
         {
      ...
      public function addASCuePoint(param1:*, param2:String = null, param3:Object = null) : Object
      {
         ...
         if((_loc8_ = _owner.getVideoPlayer(flvplayback_internal::_id).playheadTime) > 0)
         {
         ...
         (_loc9_ = flvplayback_internal::deepCopyObject(flvplayback_internal::asCuePoints[_loc7_])).array = flvplayback_internal::asCuePoints;
         _loc9_.index = _loc7_;
         return _loc9_;
      }
      ...
      public function setFLVCuePointEnabled(param1:Boolean, param2:*) : int
      {
         ...
         if(_loc4_)
         {
            ...
            else
            {
               ...
               while(_loc7_ >= 0)
               {
                  ...
                  if((_loc8_ = flvplayback_internal::getCuePointIndex(flvplayback_internal::_disabledCuePoints,true,_loc9_.time)) < 0 || flvplayback_internal::_disabledCuePoints[_loc8_].time != _loc9_.time)
                  {
         ...
         if((_loc7_ = flvplayback_internal::getCuePointIndex(flvplayback_internal::_disabledCuePoints,false,_loc3_.time,_loc3_.name)) < 0)
         {
            if(param1)
            {
               if(!flvplayback_internal::_metadataLoaded)
               {
                  if((_loc7_ = flvplayback_internal::getCuePointIndex(flvplayback_internal::_disabledCuePoints,false,_loc3_.time)) < 0)
                  {
            ...
            if(flvplayback_internal::_metadataLoaded)
            {
               if((_loc7_ = flvplayback_internal::getCuePointIndex(flvplayback_internal::flvCuePoints,false,_loc3_.time,_loc3_.name)) < 0)
               {
                  return 0;
               }
               if(_loc5_)
      ...
      public function isFLVCuePointEnabled(param1:*) : Boolean
      {
         ...
         if(_loc3_)
         {
            if((_loc5_ = flvplayback_internal::getCuePointIndex(flvplayback_internal::flvCuePoints,true,-1,_loc2_.name)) < 0)
            {
               return true;
            }
            while(_loc5_ >= 0)
      ...
      flvplayback_internal function getCuePointIndex(param1:Array, param2:Boolean, param3:Number = NaN, param4:String = null, param5:int = -1, param6:int = -1) : int
      {
         ...
         if(param6 <= flvplayback_internal::_linearSearchTolerance)
         {
            ...
            {
               if((_loc9_ = flvplayback_internal::cuePointCompare(param3,param4,param1[_loc15_])) == 0)
               {
                  return _loc15_;
               }
               if(_loc9_ < 0)
         ...
         if((_loc9_ = flvplayback_internal::cuePointCompare(param3,param4,param1[_loc11_])) < 0)
         {
