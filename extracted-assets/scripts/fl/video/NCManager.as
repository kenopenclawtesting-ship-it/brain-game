package fl.video
{
   ...
   public class NCManager implements INCManager
   {
      ...
      public function helperDone(param1:Object, param2:Boolean) : void
      {
         ...
         if((_loc4_ = flvplayback_internal::_smilMgr.flvplayback_internal::baseURLAttr[0]) != null && _loc4_ != "")
         {
      ...
      flvplayback_internal function nextConnect(param1:TimerEvent = null) : void
      {
         ...
         if(flvplayback_internal::_connTypeCounter == 0)
         {
            ...
            else
            {
               ...
               while(_loc5_ < flvplayback_internal::RTMP_CONN.length)
               {
                  ...
                  {
                     _loc3_ = flvplayback_internal::RTMP_CONN[_loc5_].port;
                     break;
                  }
                  _loc5_++;
               }
         ...
         {
            _loc2_ = flvplayback_internal::RTMP_CONN[flvplayback_internal::_connTypeCounter].protocol;
            _loc3_ = flvplayback_internal::RTMP_CONN[flvplayback_internal::_connTypeCounter].port;
         }
      ...
      public function connectAgain() : Boolean
      {
         var _loc1_:int = 0;
         var _loc2_:* = null;
         _loc1_ = int(flvplayback_internal::_appName.indexOf("/"));
         if(_loc1_ < 0)
         {
            _loc1_ = int(flvplayback_internal::_streamName.indexOf("/"));
            if(_loc1_ >= 0)
            {
      ...
      flvplayback_internal function parseURL(param1:String) : ParseResults
      {
         ...
         _loc3_ = 0;
         if((_loc4_ = int(param1.indexOf(":/",_loc3_))) >= 0)
         {
            _loc4_ += 2;
         ...
         if(_loc2_.protocol != null && (_loc2_.protocol == "rtmp:/" || _loc2_.protocol == "rtmpt:/" || _loc2_.protocol == "rtmps:/"))
         {
            ...
            {
               _loc3_++;
               _loc5_ = int(param1.indexOf(":",_loc3_));
               if((_loc6_ = int(param1.indexOf("/",_loc3_))) < 0)
               {
                  if(_loc5_ < 0)
                  {
